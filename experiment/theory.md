...
$$
\text{CaO} + H_2O \rightarrow \text{Ca(OH)}_2 + \text{Heat}
$$
...
$$
\text{MgO} + H_2O \rightarrow \text{Mg(OH)}_2
$$
...
* Initial curing at $\(27 \pm 2^\circ\text{C}\)$ for 24 hours  
...
* Preparing cement paste bars of $\(25 \times 25 \times 282\)$ mm with standard consistency  
...
$$
\text{Expansion} =
\frac{(L_2 - L_1)}{L} \times 100
$$

Where:  
* $L_1$ = Initial length measured after 24 hours of moist curing (mm)  
* $L_2$ = Final length measured after autoclaving and cooling (mm)  
